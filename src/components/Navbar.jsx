...
const ScrollLogo = () => {
    return (
        <div class="line-logo primary-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="49" height="2" fill="none" viewBox="0 0 49 2">
                <path fill="#111" fill-rule="evenodd" d="m.138489 1c0-.552285.480678-1 1.073621-1h45.85279c.5929 0 1.0736.447715 1.0736 1 0 .55228-.4807 1-1.0736 1h-45.85279c-.592943 0-1.073621-.44772-1.073621-1z" clip-rule="evenodd"></path>
            </svg>
        </div>
    )
}
